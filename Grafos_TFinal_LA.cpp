...
/*
 *  Clase Grafo
 *  (Se han usados las siguientes estructuras para los métodos de la clase)
 *  - Lista Arreglo
 *  - Lista Enlazada
...
public:
    ...
    void init(int n,char tipoGrafo) {
        ...
        //this->edges = new ListaArreglo<Edge>(100);
    ...
    void setArista(int i, int j, int w) {
            ...
            //this->edges->setValor(*new Edge{i,j,w});
    ...
    void dijkstra(int s)
    {
        ...
        pq->insertar(*new Objetopair<int,int>(0,s));
        while(pq->longitud()>0)
        {
    ...
    void prim()
    {
        ...
        pq->encolar(*new Objetopair<int,int>(0,0));
        int mst=0;
        while(pq->longitud()>0)
        {
    ...
    void kruskal()
    {
       ...
       while(!edges.empty())
       {
        ...
        cout<<"distancia kruskal :"<<mst<<endl;
    }
    void kruskal_ruta(int ini,int fin)
    {
        ...
        while(!edges.empty())
        {
            ...
            {
                mst+=edges.begin()->w;
                cout<<"sobre :"<<edges.begin()->v<<endl;
                //if(fin==edges.begin()->v) break;
            }
            edges.erase(edges.begin());
        }
        cout<<"distancia kruskal :"<<mst<<endl;
...
*/
    ...
    GrafoLA *grafo = new GrafoLA(5,'D');
    grafo->setArista(0,1, 1);
    grafo->setArista(0,2, 6);
    grafo->setArista(0,3, 4);
    grafo->setArista(1,2, 1);
    grafo->setArista(1,4, 2);
    grafo->setArista(3,4, 7);
